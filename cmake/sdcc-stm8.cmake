set(STM8_SUPPORTED_SERIES S L AF CACHE INTERNAL "supported stm8 series")
...
if(NOT STM8_SERIES)
    ...
    if(NOT STM8_CHIP)
        ...
        string(REGEX REPLACE "^[sS][tT][mM]8([sS]|[lL]|af|AF).+$" "\\1" STM8_SERIES ${STM8_CHIP})
...
function(STM8_SET_PROJECT_PROPERTIES)
    if(NOT STM8_CHIP_TYPE)
        STM8_GET_CHIP_TYPE(${STM8_CHIP} STM8_CHIP_TYPE)
    endif()
    message(STATUS "Selected STM8_CHIP_TYPE: ${STM8_CHIP_TYPE}")
    STM8_SET_PROJECT_DEFINITIONS(${STM8_CHIP_TYPE})
endfunction()
